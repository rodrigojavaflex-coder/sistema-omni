 ...
 */
export class DropPermiteNovaIrregularidadeMatriz1739530000000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    if (
      tabela &&
      !tabela.findColumnByName('permite_nova_irregularidade_se_ja_existe')
    ) {
      await queryRunner.query(
