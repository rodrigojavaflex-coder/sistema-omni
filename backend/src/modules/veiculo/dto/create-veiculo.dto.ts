...
export class CreateVeiculoDto {
  ...
  @ApiProperty({
    description: 'Marca da carroceria',
    example: 'Marcopolo',
    maxLength: 50,
    required: false,
  })
  ...
  @MaxLength(50, {
    message: 'Marca da carroceria não pode ter mais de 50 caracteres',
  })
  marcaDaCarroceria?: string;

  @ApiProperty({
    description: 'Modelo da carroceria',
    example: 'Volare',
    maxLength: 50,
    required: false,
  })
  ...
  @MaxLength(50, {
    message: 'Modelo da carroceria não pode ter mais de 50 caracteres',
  })
