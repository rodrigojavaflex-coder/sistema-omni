...
function VistoriaAreasPage_ion_button_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "rect", 18)(3, "path", 19)(4, "path", 20)(5, "path", 21);
    \u0275\u0275elementEnd()();
  }
}
function VistoriaAreasPage_div_18_ng_container_8_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", ctx_r1.selectedArea.nome, " ");
  }
}
function VistoriaAreasPage_div_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 22)(1, "p", 23)(2, "strong");
    \u0275\u0275text(3, "Vistoria:");
    \u0275\u0275elementEnd();
    \u0275\u0275text(4);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(7);
    \u0275\u0275template(8, VistoriaAreasPage_div_18_ng_container_8_Template, 5, 1, "ng-container", 16);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r1.veiculoNumero, " ");
    \u0275\u0275advance();
...
function VistoriaAreasPage_div_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function VistoriaAreasPage_div_20_Template_ion_button_click_4_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
function VistoriaAreasPage_div_21_ion_card_2_ion_card_content_4_p_1_Template(rf, ctx) {
  if (rf & 1) {
...
function VistoriaAreasPage_div_21_ion_card_2_ion_card_content_4_p_2_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" Pendencias em vistorias anteriores: ", ctx_r1.contagemPendentesPorArea[area_r5.id], " ");
  }
}
function VistoriaAreasPage_div_21_ion_card_2_ion_card_content_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-card-content");
    \u0275\u0275template(1, VistoriaAreasPage_div_21_ion_card_2_ion_card_content_4_p_1_Template, 3, 1, "p", 16)(2, VistoriaAreasPage_div_21_ion_card_2_ion_card_content_4_p_2_Template, 3, 1, "p", 33);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function VistoriaAreasPage_div_21_ion_card_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "ion-card", 32);
    \u0275\u0275listener("click", function VistoriaAreasPage_div_21_ion_card_2_Template_ion_card_click_0_listener() {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(4, VistoriaAreasPage_div_21_ion_card_2_ion_card_content_4_Template, 3, 2, "ion-card-content", 16);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function VistoriaAreasPage_div_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(2, VistoriaAreasPage_div_21_ion_card_2_Template, 5, 2, "ion-card", 31);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function VistoriaAreasPage_div_22_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function VistoriaAreasPage_div_22_Template_ion_button_click_3_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.carregarAreas());
    });
...
function VistoriaAreasPage_div_23_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "ion-button", 28);
    \u0275\u0275listener("click", function VistoriaAreasPage_div_23_div_1_Template_ion_button_click_4_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function VistoriaAreasPage_div_23_div_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24);
    \u0275\u0275element(1, "ion-spinner", 25);
    \u0275\u0275elementStart(2, "p");
...
function VistoriaAreasPage_div_23_div_3_Template(rf, ctx) {
  if (rf & 1) {
...
function VistoriaAreasPage_div_23_div_4_ion_card_1_ion_card_content_4_p_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p")(1, "ion-text", 34);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function VistoriaAreasPage_div_23_div_4_ion_card_1_ion_card_content_4_p_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 35)(1, "ion-text", 36);
...
function VistoriaAreasPage_div_23_div_4_ion_card_1_ion_card_content_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-card-content");
    \u0275\u0275template(1, VistoriaAreasPage_div_23_div_4_ion_card_1_ion_card_content_4_p_1_Template, 3, 1, "p", 16)(2, VistoriaAreasPage_div_23_div_4_ion_card_1_ion_card_content_4_p_2_Template, 3, 0, "p", 33);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.pendentesPorComponente.has(item_r9.idComponente));
  }
}
function VistoriaAreasPage_div_23_div_4_ion_card_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "ion-card", 32);
    \u0275\u0275listener("click", function VistoriaAreasPage_div_23_div_4_ion_card_1_Template_ion_card_click_0_listener() {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(4, VistoriaAreasPage_div_23_div_4_ion_card_1_ion_card_content_4_Template, 3, 2, "ion-card-content", 16);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.irregularidadesPorComponente[item_r9.idComponente] > 0 || ctx_r1.pendentesPorComponente.has(item_r9.idComponente));
  }
}
function VistoriaAreasPage_div_23_div_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 30);
    \u0275\u0275template(1, VistoriaAreasPage_div_23_div_4_ion_card_1_Template, 5, 2, "ion-card", 31);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function VistoriaAreasPage_div_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, VistoriaAreasPage_div_23_div_1_Template, 6, 1, "div", 14)(2, VistoriaAreasPage_div_23_div_2_Template, 4, 0, "div", 14)(3, VistoriaAreasPage_div_23_div_3_Template, 3, 0, "div", 16)(4, VistoriaAreasPage_div_23_div_4_Template, 2, 1, "div", 37);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function VistoriaAreasPage_ion_footer_24_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "ion-footer")(1, "ion-toolbar")(2, "ion-button", 38);
    \u0275\u0275listener("click", function VistoriaAreasPage_ion_footer_24_Template_ion_button_click_2_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext();
...
var VistoriaAreasPage = class _VistoriaAreasPage {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VistoriaAreasPage, selectors: [["app-vistoria-areas"]], decls: 25, vars: 11, consts: [[3, "translucent"], ["slot", "start"], ["slot", "end"], ["class", "resumo-btn", "fill", "solid", "color", "medium", "aria-label", "Pendencias de outras vistorias", 3, "click", 4, "ngIf"], ["fill", "solid", "color", "medium", "aria-label", "Resumo da vistoria", 1, "resumo-btn", 3, "click"], ["xmlns", "http://www.w3.org/2000/svg", "width", "18", "height", "18", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round", "aria-hidden", "true"], ["d", "m3 17 2 2 4-4"], ["d", "m3 7 2 2 4-4"], ["d", "M13 6h8"], ["d", "M13 12h8"], ["d", "M13 18h8"], ["fill", "solid", 3, "click"], [3, "fullscreen"], ["class", "selected-context", 4, "ngIf"], ["class", "content", 4, "ngIf"], ["class", "content sheet-context", 4, "ngIf"], [4, "ngIf"], ["fill", "solid", "color", "medium", "aria-label", "Pendencias de outras vistorias", 1, "resumo-btn", 3, "click"], ["x", "8", "y", "2", "width", "8", "height", "4", "rx", "1"], ["d", "M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"], ["d", "M9 12h6"], ["d", "M9 16h6"], [1, "selected-context"], [1, "context-inline"], [1, "content"], ["name", "crescent"], ["color", "danger"], [1, "error-message"], ["fill", "outline", 3, "click"], [1, "content", "sheet-context"], [1, "cards-container"], ["button", "", "class", "level-card", 3, "click", 4, "ngFor", "ngForOf"], ["button", "", 1, "level-card", 3, "click"], ["class", "ion-text-wrap", 4, "ngIf"], ["color", "primary"], [1, "ion-text-wrap"], ["color", "warning"], ["class", "cards-container", 4, "ngIf"], ["expand", "block", 3, "click"]], template: function VistoriaAreasPage_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function VistoriaAreasPage_Template_ion_button_click_15_listener() {
        return ctx.voltarOuFechar();
      });
      \u0275\u0275text(16, "Voltar");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(17, "ion-content", 12);
      \u0275\u0275template(18, VistoriaAreasPage_div_18_Template, 9, 3, "div", 13)(19, VistoriaAreasPage_div_19_Template, 4, 0, "div", 14)(20, VistoriaAreasPage_div_20_Template, 6, 1, "div", 14)(21, VistoriaAreasPage_div_21_Template, 3, 1, "div", 15)(22, VistoriaAreasPage_div_22_Template, 5, 0, "div", 14)(23, VistoriaAreasPage_div_23_Template, 5, 4, "div", 15);
      \u0275\u0275elementEnd();
      \u0275\u0275template(24, VistoriaAreasPage_ion_footer_24_Template, 4, 0, "ion-footer", 16);
    }
    if (rf & 2) {
...
(() => {
  ...
  <ion-toolbar>\r
    ...
    <ion-buttons slot="end">\r
      <ion-button\r
        *ngIf="canViewHistoricoVeiculo"\r
        class="resumo-btn"\r
        fill="solid"\r
        color="medium"\r
...
//# sourceMappingURL=chunk-DBZSJ2WP.js.map
