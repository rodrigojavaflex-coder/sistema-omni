...
} from "./chunk-NQNG7RPV.js";
import {
  VistoriaBootstrapService
} from "./chunk-EEM34LAU.js";
import {
  VistoriaService
...
var VoiceRecorder = registerPlugin("VoiceRecorder", {
  web: () => import("./chunk-I74MQ2LS.js").then((m) => new m.VoiceRecorderWeb())
});
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VistoriaIrregularidadePage, { className: "VistoriaIrregularidadePage", filePath: "app/pages/vistoria/vistoria-irregularidade.page.ts", lineNumber: 112 });
})();
export {
  VistoriaIrregularidadePage
};
//# sourceMappingURL=chunk-4HDE4JPT.js.map
