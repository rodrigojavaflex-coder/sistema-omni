...
function VistoriaFinalizarPage_div_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx_r1.resumoRotuloPercentual, ":");
    \u0275\u0275advance();
...
var VistoriaFinalizarPage = class _VistoriaFinalizarPage {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VistoriaFinalizarPage, selectors: [["app-vistoria-finalizar"]], decls: 33, vars: 11, consts: [[3, "translucent"], ["slot", "start"], ["menu", "main-menu"], [3, "fullscreen"], [1, "content"], ["class", "resumo-vistoria", 4, "ngIf"], ["position", "stacked", 1, "tempo-total-label"], ["xmlns", "http://www.w3.org/2000/svg", "width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round", "aria-hidden", "true"], ["cx", "12", "cy", "12", "r", "10"], ["points", "12 6 12 12 16 14"], [1, "tempo-total-valor"], ["position", "stacked"], ["placeholder", "Observa\xE7\xE3o opcional", 3, "ngModelChange", "ngModel"], ["color", "danger", 4, "ngIf"], [1, "footer-actions"], [1, "btn-main", 3, "click", "disabled"], ["name", "crescent", 4, "ngIf"], [4, "ngIf"], ["fill", "solid", 1, "btn-voltar", 3, "click"], ["class", "sucesso-overlay", "aria-modal", "true", "role", "dialog", 4, "ngIf"], [1, "resumo-vistoria"], ["class", "irregularidades-lista", 4, "ngIf"], [1, "irregularidades-lista"], ["color", "danger"], [1, "error-message"], ["name", "crescent"], ["aria-modal", "true", "role", "dialog", 1, "sucesso-overlay"], [1, "sucesso-card"], [1, "irregularidades-lista-overlay"], ["expand", "block", 3, "click"]], template: function VistoriaFinalizarPage_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(6, "ion-content", 3)(7, "div", 4);
      \u0275\u0275template(8, VistoriaFinalizarPage_div_8_Template, 30, 9, "div", 5)(9, VistoriaFinalizarPage_div_9_Template, 3, 0, "div", 5);
      \u0275\u0275elementStart(10, "ion-item")(11, "ion-label", 6)(12, "span");
      \u0275\u0275text(13, "Tempo total (minutos):");
      \u0275\u0275elementEnd();
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(14, "svg", 7);
      \u0275\u0275element(15, "circle", 8)(16, "polyline", 9);
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(17, "ion-text", 10);
      \u0275\u0275text(18);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(19, "ion-item")(20, "ion-label", 11);
      \u0275\u0275text(21, "Observa\xE7\xE3o geral");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(22, "ion-textarea", 12);
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275template(23, VistoriaFinalizarPage_ion_text_23_Template, 3, 1, "ion-text", 13);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(24, "ion-footer")(25, "ion-toolbar")(26, "div", 14)(27, "ion-button", 15);
      \u0275\u0275listener("click", function VistoriaFinalizarPage_Template_ion_button_click_27_listener() {
        return ctx.finalizar();
      });
      \u0275\u0275template(28, VistoriaFinalizarPage_ion_spinner_28_Template, 1, 0, "ion-spinner", 16)(29, VistoriaFinalizarPage_span_29_Template, 2, 0, "span", 17);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(31, " Voltar ");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275template(32, VistoriaFinalizarPage_div_32_Template, 37, 9, "div", 19);
    }
    if (rf & 2) {
