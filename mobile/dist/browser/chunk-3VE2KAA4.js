...
function VistoriaHistoricoVeiculoPage_div_10_ion_card_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(7, "Total de n\xE3o resolvidas:");
    \u0275\u0275elementEnd();
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()()();
  }
...
function VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_div_17_img_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "img", 40);
    \u0275\u0275listener("pointerup", function VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_div_17_img_1_Template_img_pointerup_0_listener() {
      const midia_r10 = \u0275\u0275restoreView(_r9).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(5);
      return \u0275\u0275resetView(ctx_r1.abrirImagem(midia_r10.nomeArquivo, midia_r10.dadosBase64, midia_r10.mimeType));
    })("click", function VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_div_17_img_1_Template_img_click_0_listener() {
      const midia_r10 = \u0275\u0275restoreView(_r9).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(5);
      return \u0275\u0275resetView(ctx_r1.abrirImagem(midia_r10.nomeArquivo, midia_r10.dadosBase64, midia_r10.mimeType));
    });
  ...
  if (rf & 2) {
    const midia_r10 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext(5);
    \u0275\u0275property("src", ctx_r1.getMidiaSrc(midia_r10.dadosBase64, midia_r10.mimeType), \u0275\u0275sanitizeUrl)("alt", midia_r10.nomeArquivo);
  }
}
function VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_div_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 38);
    \u0275\u0275template(1, VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_div_17_img_1_Template, 1, 2, "img", 39);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r1.getImagens(item_r11));
  }
}
function VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_ng_template_18_Template(rf, ctx) {
  if (rf & 1) {
...
function VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_div_23_div_1_span_3_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const midia_r12 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext(5);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("(", ctx_r1.formatarDuracao(midia_r12.duracaoMs), ")");
  }
}
function VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_div_23_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 44)(1, "p", 45);
    \u0275\u0275text(2);
    \u0275\u0275template(3, VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_div_23_div_1_span_3_Template, 2, 1, "span", 16);
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "audio", 46);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(5);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", midia_r12.nomeArquivo, " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.formatarDuracao(midia_r12.duracaoMs));
    \u0275\u0275advance();
    \u0275\u0275property("src", ctx_r1.getMidiaSrc(midia_r12.dadosBase64, midia_r12.mimeType), \u0275\u0275sanitizeUrl);
  }
}
function VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_div_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 42);
    \u0275\u0275template(1, VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_div_23_div_1_Template, 5, 3, "div", 43);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const item_r11 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r1.getAudios(item_r11));
  }
}
function VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_ng_template_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 41);
    \u0275\u0275text(1, "Sem audio");
    \u0275\u0275elementEnd();
...
function VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "div", 35)(14, "p")(15, "strong");
    \u0275\u0275text(16, "Imagens");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(17, VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_div_17_Template, 2, 1, "div", 36)(18, VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_ng_template_18_Template, 2, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementStart(20, "p")(21, "strong");
    \u0275\u0275text(22, "\xC1udios");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(23, VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_div_23_Template, 2, 1, "div", 37)(24, VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_ng_template_24_Template, 2, 0, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const item_r11 = ctx.$implicit;
    const semImagensTpl_r13 = \u0275\u0275reference(19);
    const semAudiosTpl_r14 = \u0275\u0275reference(25);
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate3(" ", item_r11.nomeArea || "\xC1rea", " - ", item_r11.nomeComponente || "Componente", " - ", item_r11.descricaoSintoma || "Sintoma", " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate2(" ", item_r11.numeroVistoria, " (", ctx_r1.formatarData(item_r11.datavistoria), ")");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", item_r11.observacao || "-");
    \u0275\u0275advance(5);
    \u0275\u0275property("ngIf", ctx_r1.getImagens(item_r11).length > 0)("ngIfElse", semImagensTpl_r13);
    \u0275\u0275advance(6);
    \u0275\u0275property("ngIf", ctx_r1.getAudios(item_r11).length > 0)("ngIfElse", semAudiosTpl_r14);
  }
}
function VistoriaHistoricoVeiculoPage_div_10_div_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 32);
    \u0275\u0275template(1, VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_Template, 26, 10, "ion-card", 33);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function VistoriaHistoricoVeiculoPage_div_10_ng_template_20_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 48);
    \u0275\u0275text(1, "Selecione um ve\xEDculo para visualizar o hist\xF3rico.");
    \u0275\u0275elementEnd();
  }
}
function VistoriaHistoricoVeiculoPage_div_10_ng_template_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, VistoriaHistoricoVeiculoPage_div_10_ng_template_20_p_0_Template, 2, 0, "p", 47)(1, VistoriaHistoricoVeiculoPage_div_10_ng_template_20_ng_template_1_Template, 2, 0, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    const selectVehicleHint_r15 = \u0275\u0275reference(2);
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("ngIf", ctx_r1.selectedVeiculoId)("ngIfElse", selectVehicleHint_r15);
  }
}
function VistoriaHistoricoVeiculoPage_div_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const emptyState_r16 = \u0275\u0275reference(21);
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.selectedVeiculoId && ctx_r1.itensFiltrados.length > 0)("ngIfElse", emptyState_r16);
  }
}
function VistoriaHistoricoVeiculoPage_div_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "ion-button", 52);
...
var VistoriaHistoricoVeiculoPage = class _VistoriaHistoricoVeiculoPage {
  ...
  getMidiaSrc(dadosBase64, mimeType) {
    return `data:${mimeType};base64,${dadosBase64}`;
  }
  abrirImagem(nomeArquivo, dadosBase64, mimeType) {
  ...
  carregar(veiculoId) {
    return __async(this, null, function* () {
      ...
      try {
        ...
        this.errorMessage = this.errorMessageService.fromApi(error, "Nao foi possivel carregar o historico do veiculo.");
      } finally {
        this.loading = false;
      }
    });
...
(() => {
  ...
  <ion-toolbar>\r
    ...
    <ion-title>Hist\xF3rico do Ve\xEDculo</ion-title>\r
...
\r
    <ion-card *ngIf="selectedVeiculoId">\r
      <ion-card-content>\r
        ...
        <p><strong>Total de n\xE3o resolvidas:</strong> {{ total }}</p>\r
      </ion-card-content>\r
    </ion-card>\r
\r
    <ion-item>\r
            ...
            <div class="imagem-grid" *ngIf="getImagens(item).length > 0; else semImagensTpl">\r
              <img\r
                *ngFor="let midia of getImagens(item)"\r
                [src]="getMidiaSrc(midia.dadosBase64, midia.mimeType)"\r
                [alt]="midia.nomeArquivo"\r
                (pointerup)="abrirImagem(midia.nomeArquivo, midia.dadosBase64, midia.mimeType)"\r
                (click)="abrirImagem(midia.nomeArquivo, midia.dadosBase64, midia.mimeType)"\r
              />\r
            </div>\r
...
\r
            ...
            <div class="audio-list" *ngIf="getAudios(item).length > 0; else semAudiosTpl">\r
              <div *ngFor="let midia of getAudios(item)" class="audio-item">\r
                ...
                <audio [src]="getMidiaSrc(midia.dadosBase64, midia.mimeType)" controls preload="metadata"></audio>\r
              </div>\r
            </div>\r
...
\r
    <ng-template #emptyState>\r
      ...
      <ng-template #selectVehicleHint>\r
        <p class="empty-text">Selecione um ve\xEDculo para visualizar o hist\xF3rico.</p>\r
      </ng-template>\r
    </ng-template>\r
  </div>\r
</ion-content>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VistoriaHistoricoVeiculoPage, { className: "VistoriaHistoricoVeiculoPage", filePath: "src/app/pages/vistoria/vistoria-historico-veiculo.page.ts", lineNumber: 68 });
})();
export {
  VistoriaHistoricoVeiculoPage
};
//# sourceMappingURL=chunk-3VE2KAA4.js.map
