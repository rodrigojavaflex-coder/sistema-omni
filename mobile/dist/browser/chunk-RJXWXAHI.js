...
function HomePage_div_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(ctx_r0.user.perfil.nome);
    \u0275\u0275advance(4);
...
var HomePage = class _HomePage {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HomePage, selectors: [["app-home"]], decls: 7, vars: 4, consts: [[3, "translucent"], ["slot", "start", 4, "ngIf"], [3, "fullscreen"], ["class", "home-container", 4, "ngIf"], ["slot", "start"], [1, "home-container"], [1, "profile-card"], [1, "profile-header"], [1, "avatar"], [1, "profile-title"], [1, "profile-details"], [1, "detail-row"], [1, "detail-label"], [1, "detail-value"], [1, "detail-badge"]], template: function HomePage_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275template(6, HomePage_div_6_Template, 21, 7, "div", 3);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
    ...
    <div class="profile-card">
      ...
      <div class="profile-details">
        <div class="detail-row">
          ...
          <span class="detail-value">{{ user.perfil.nome }}</span>
        </div>
        <div class="detail-row">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HomePage, { className: "HomePage", filePath: "src/app/pages/home/home.page.ts", lineNumber: 30 });
})();
export {
  HomePage
};
//# sourceMappingURL=chunk-RJXWXAHI.js.map
