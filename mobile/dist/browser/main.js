...
var routes = [
  ...
  {
    path: "login",
    loadComponent: () => import("./chunk-R72UTCBD.js").then((m) => m.LoginPage),
    canActivate: [guestGuard]
  },
  {
    path: "redefinir-senha",
    loadComponent: () => import("./chunk-PWTPNECU.js").then((m) => m.RedefinirSenhaPage)
  },
  {
    path: "home",
    loadComponent: () => import("./chunk-3MV2NO2O.js").then((m) => m.HomePage),
    canActivate: [authGuard]
  },
  {
    path: "configuracoes",
    loadComponent: () => import("./chunk-O6VILEIS.js").then((m) => m.ConfiguracoesPage),
    canActivate: [authGuard]
  },
  {
    path: "alterar-senha",
    loadComponent: () => import("./chunk-YZOZRBSA.js").then((m) => m.AlterarSenhaPage),
    canActivate: [authGuard]
  },
  {
    path: "sobre",
    loadComponent: () => import("./chunk-KYM6M5GI.js").then((m) => m.SobrePage),
    canActivate: [authGuard]
  },
  {
    path: "vistoria/inicio",
    loadComponent: () => import("./chunk-7XDBSKXY.js").then((m) => m.VistoriaInicioPage),
    canActivate: [authGuard, permissionGuard],
    data: { permissions: ["vistoria_mobile:create"] }
  },
  {
    path: "vistoria/areas",
    loadComponent: () => import("./chunk-WT54GFHK.js").then((m) => m.VistoriaAreasPage),
    canActivate: [authGuard, permissionGuard],
    data: { permissions: ["vistoria_mobile:create"] }
  },
  {
    path: "vistoria/areas/:areaId",
    loadComponent: () => import("./chunk-43QMNE5J.js").then((m) => m.VistoriaComponentesPage),
    canActivate: [authGuard, permissionGuard],
    data: { permissions: ["vistoria_mobile:create"] }
  },
  {
    path: "vistoria/areas/:areaId/componentes/:componenteId",
    loadComponent: () => import("./chunk-RP6JGLCX.js").then((m) => m.VistoriaIrregularidadePage),
    canActivate: [authGuard, permissionGuard],
    data: { permissions: ["vistoria_mobile:create"] }
  },
  {
    path: "vistoria/finalizar",
    loadComponent: () => import("./chunk-FO6QZTDH.js").then((m) => m.VistoriaFinalizarPage),
    canActivate: [authGuard, permissionGuard],
    data: { permissions: ["vistoria_mobile:create"] }
  },
  {
    path: "vistoria/pendencias-veiculo",
    loadComponent: () => import("./chunk-FWYWSGX4.js").then((m) => m.VistoriaHistoricoVeiculoPage),
    canActivate: [authGuard, permissionGuard],
...
function AppComponent_ion_menu_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AppComponent_ion_menu_1_Template_ion_item_click_17_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.goTo("/alterar-senha"));
    });
    \u0275\u0275element(18, "ion-icon", 13);
    \u0275\u0275elementStart(19, "ion-label", 12);
    \u0275\u0275text(20, "Alterar senha");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "ion-item", 10);
    \u0275\u0275listener("click", function AppComponent_ion_menu_1_Template_ion_item_click_21_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.goTo("/sobre"));
    });
    \u0275\u0275element(22, "ion-icon", 14);
    \u0275\u0275elementStart(23, "ion-label", 12);
    \u0275\u0275text(24, "Sobre");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(25, "div", 15)(26, "ion-button", 16);
    \u0275\u0275listener("click", function AppComponent_ion_menu_1_Template_ion_button_click_26_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
var AppComponent = class _AppComponent {
  ...
  goTo(route, state) {
    return __async(this, null, function* () {
      if (this.hasVistoriaEmAndamento && (route === "/vistoria/pendencias-veiculo" || route === "/configuracoes" || route === "/alterar-senha" || route === "/sobre")) {
        return;
      }
    ...
    <ion-content class="menu-content">
      ...
      <ion-list class="menu-list">
        ...
        <ion-item
          ...
          class="menu-item"
          [class.menu-item-disabled]="hasVistoriaEmAndamento"
          (click)="goTo('/alterar-senha')"
        >
          <ion-icon name="key-outline" slot="start" class="menu-item-icon"></ion-icon>
          <ion-label class="menu-item-label">Alterar senha</ion-label>
        </ion-item>
        <ion-item
          lines="none"
          button
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppComponent, { className: "AppComponent", filePath: "app/app.component.ts", lineNumber: 58 });
})();
