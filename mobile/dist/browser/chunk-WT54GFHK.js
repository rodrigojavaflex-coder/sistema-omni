...
function VistoriaAreasPage_div_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 22)(1, "div", 23)(2, "strong");
    \u0275\u0275text(3, "Vistoria:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "span");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 23)(7, "strong");
    \u0275\u0275text(8, "Ve\xEDculo:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "span");
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(11, VistoriaAreasPage_div_16_div_11_Template, 5, 1, "div", 24);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function VistoriaAreasPage_div_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 25)(1, "ion-text", 27)(2, "p", 28);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "ion-button", 29);
...
function VistoriaAreasPage_div_19_ion_card_4_ion_card_content_4_p_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p")(1, "ion-text", 36);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function VistoriaAreasPage_div_19_ion_card_4_ion_card_content_4_p_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 37)(1, "ion-text", 38);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function VistoriaAreasPage_div_19_ion_card_4_ion_card_content_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, VistoriaAreasPage_div_19_ion_card_4_ion_card_content_4_p_1_Template, 3, 1, "p", 16)(2, VistoriaAreasPage_div_19_ion_card_4_ion_card_content_4_p_2_Template, 3, 1, "p", 35);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function VistoriaAreasPage_div_19_ion_card_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(4, VistoriaAreasPage_div_19_ion_card_4_ion_card_content_4_Template, 3, 2, "ion-card-content", 16);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function VistoriaAreasPage_div_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(4, VistoriaAreasPage_div_19_ion_card_4_Template, 5, 2, "ion-card", 33);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function VistoriaAreasPage_div_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "ion-button", 29);
...
function VistoriaAreasPage_div_21_div_5_ion_card_1_ion_card_content_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-card-content");
    \u0275\u0275template(1, VistoriaAreasPage_div_21_div_5_ion_card_1_ion_card_content_4_p_1_Template, 3, 1, "p", 16)(2, VistoriaAreasPage_div_21_div_5_ion_card_1_ion_card_content_4_p_2_Template, 3, 1, "p", 35);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function VistoriaAreasPage_div_21_div_5_ion_card_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(4, VistoriaAreasPage_div_21_div_5_ion_card_1_ion_card_content_4_Template, 3, 2, "ion-card-content", 16);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function VistoriaAreasPage_div_21_div_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, VistoriaAreasPage_div_21_div_5_ion_card_1_Template, 5, 2, "ion-card", 33);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function VistoriaAreasPage_div_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, VistoriaAreasPage_div_21_div_1_Template, 6, 1, "div", 14)(2, VistoriaAreasPage_div_21_div_2_Template, 4, 0, "div", 14)(3, VistoriaAreasPage_div_21_div_3_Template, 3, 0, "div", 16)(4, VistoriaAreasPage_div_21_p_4_Template, 2, 0, "p", 39)(5, VistoriaAreasPage_div_21_div_5_Template, 2, 1, "div", 40);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function VistoriaAreasPage_ion_footer_22_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "ion-footer")(1, "ion-toolbar")(2, "div", 41)(3, "ion-button", 42);
...
var VistoriaAreasPage = class _VistoriaAreasPage {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VistoriaAreasPage, selectors: [["app-vistoria-areas"]], decls: 23, vars: 11, consts: [[3, "translucent"], ["slot", "start"], ["menu", "main-menu"], ["slot", "end"], ["class", "resumo-btn", "fill", "solid", "color", "medium", "aria-label", "Pendencias de outras vistorias", 3, "click", 4, "ngIf"], ["fill", "solid", "color", "medium", "aria-label", "Resumo da vistoria", 1, "resumo-btn", 3, "click"], ["xmlns", "http://www.w3.org/2000/svg", "width", "18", "height", "18", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round", "aria-hidden", "true"], ["d", "m3 17 2 2 4-4"], ["d", "m3 7 2 2 4-4"], ["d", "M13 6h8"], ["d", "M13 12h8"], ["d", "M13 18h8"], [3, "fullscreen"], ["class", "selected-context", 4, "ngIf"], ["class", "content", 4, "ngIf"], ["class", "content sheet-context", 4, "ngIf"], [4, "ngIf"], ["fill", "solid", "color", "medium", "aria-label", "Pendencias de outras vistorias", 1, "resumo-btn", 3, "click"], ["x", "8", "y", "2", "width", "8", "height", "4", "rx", "1"], ["d", "M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"], ["d", "M9 12h6"], ["d", "M9 16h6"], [1, "selected-context"], [1, "context-card"], ["class", "context-card", 4, "ngIf"], [1, "content"], ["name", "crescent"], ["color", "danger"], [1, "error-message"], ["fill", "outline", 3, "click"], [1, "content", "sheet-context"], [1, "cards-selection-title"], [1, "cards-container"], ["button", "", "class", "level-card", 3, "click", 4, "ngFor", "ngForOf"], ["button", "", 1, "level-card", 3, "click"], ["class", "ion-text-wrap", 4, "ngIf"], ["color", "primary"], [1, "ion-text-wrap"], ["color", "warning"], ["class", "cards-selection-title", 4, "ngIf"], ["class", "cards-container", 4, "ngIf"], [1, "footer-actions"], [1, "btn-main", 3, "click"], ["class", "btn-cancelar", "fill", "solid", 3, "disabled", "click", 4, "ngIf"], ["class", "btn-voltar", "fill", "solid", 3, "click", 4, "ngIf"], ["fill", "solid", 1, "btn-cancelar", 3, "click", "disabled"], ["name", "crescent", 4, "ngIf"], ["fill", "solid", 1, "btn-voltar", 3, "click"]], template: function VistoriaAreasPage_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275template(7, VistoriaAreasPage_ion_button_7_Template, 6, 0, "ion-button", 4);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VistoriaAreasPage, { className: "VistoriaAreasPage", filePath: "app/pages/vistoria/vistoria-areas.page.ts", lineNumber: 59 });
})();
export {
  VistoriaAreasPage
};
//# sourceMappingURL=chunk-WT54GFHK.js.map
