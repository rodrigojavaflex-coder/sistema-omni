...
function HomePage_ion_buttons_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "ion-menu-button", 5);
    \u0275\u0275elementEnd();
  }
}
function HomePage_div_6_div_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 17)(1, "ion-button", 18);
...
function HomePage_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(20);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(21, HomePage_div_6_div_21_Template, 3, 0, "div", 16);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var HomePage = class _HomePage {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HomePage, selectors: [["app-home"]], decls: 7, vars: 4, consts: [[3, "translucent"], ["slot", "start", 4, "ngIf"], [3, "fullscreen"], ["class", "home-container", 4, "ngIf"], ["slot", "start"], ["menu", "main-menu"], [1, "home-container"], [1, "profile-card"], [1, "profile-header"], [1, "avatar"], [1, "profile-title"], [1, "profile-details"], [1, "detail-row"], [1, "detail-label"], [1, "detail-value"], [1, "detail-badge"], ["class", "home-actions", 4, "ngIf"], [1, "home-actions"], ["expand", "block", "routerLink", "/vistoria/inicio"]], template: function HomePage_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HomePage, { className: "HomePage", filePath: "app/pages/home/home.page.ts", lineNumber: 37 });
})();
export {
  HomePage
};
//# sourceMappingURL=chunk-3MV2NO2O.js.map
