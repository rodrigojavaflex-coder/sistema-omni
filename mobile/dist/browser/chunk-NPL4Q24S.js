import {
  VeiculoService
} from "./chunk-KRIHLZTU.js";
import {
  VistoriaService
} from "./chunk-X4WRCMZZ.js";
import {
  VistoriaFlowService
...
function VistoriaHistoricoVeiculoPage_ion_buttons_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "ion-buttons", 11)(1, "ion-button", 12);
...
function VistoriaHistoricoVeiculoPage_div_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 13)(1, "ion-text", 15)(2, "p", 16);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function VistoriaHistoricoVeiculoPage_div_10_ion_item_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "ion-item")(1, "ion-label", 25);
    \u0275\u0275text(2, "Selecionar ve\xEDculo");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "ion-searchbar", 26);
...
function VistoriaHistoricoVeiculoPage_div_10_ion_card_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-card", 28)(1, "ion-card-content");
    \u0275\u0275template(2, VistoriaHistoricoVeiculoPage_div_10_ion_card_3_ion_item_2_Template, 6, 2, "ion-item", 29);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function VistoriaHistoricoVeiculoPage_div_10_ion_card_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-card")(1, "ion-card-content")(2, "p", 31)(3, "strong");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
...
function VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_ng_container_26_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_ng_container_26_div_4_img_1_Template, 1, 2, "img", 46);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_ng_container_26_div_10_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275template(3, VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_ng_container_26_div_10_div_1_span_3_Template, 2, 1, "span", 17);
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "audio", 53);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_ng_container_26_div_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_ng_container_26_div_10_div_1_Template, 5, 3, "div", 50);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const item_r10 = \u0275\u0275nextContext(2).$implicit;
...
function VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_ng_container_26_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3, "Imagens");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(4, VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_ng_container_26_div_4_Template, 2, 1, "div", 43)(5, VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_ng_container_26_ng_template_5_Template, 2, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementStart(7, "p")(8, "strong");
    \u0275\u0275text(9, "\xC1udios");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(10, VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_ng_container_26_div_10_Template, 2, 1, "div", 44)(11, VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_ng_container_26_ng_template_11_Template, 2, 0, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "ion-card", 35)(1, "ion-card-header")(2, "ion-card-title");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "div", 36)(14, "div", 37)(15, "div")(16, "p")(17, "strong");
    \u0275\u0275text(18, "M\xEDdias");
    \u0275\u0275elementEnd();
    \u0275\u0275text(19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "p", 38);
    \u0275\u0275text(21);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "ion-button", 39);
    ...
    \u0275\u0275template(23, VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_ion_spinner_23_Template, 1, 0, "ion-spinner", 40)(24, VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_span_24_Template, 2, 1, "span", 17);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(25, VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_div_25_Template, 4, 0, "div", 41)(26, VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_ng_container_26_Template, 13, 4, "ng-container", 17);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function VistoriaHistoricoVeiculoPage_div_10_div_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, VistoriaHistoricoVeiculoPage_div_10_div_19_ion_card_1_Template, 27, 14, "ion-card", 34);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function VistoriaHistoricoVeiculoPage_div_10_ng_template_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, VistoriaHistoricoVeiculoPage_div_10_ng_template_20_p_0_Template, 2, 0, "p", 54)(1, VistoriaHistoricoVeiculoPage_div_10_ng_template_20_ng_template_1_Template, 2, 0, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
...
function VistoriaHistoricoVeiculoPage_div_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 13);
    \u0275\u0275template(1, VistoriaHistoricoVeiculoPage_div_10_ion_item_1_Template, 4, 1, "ion-item", 17)(2, VistoriaHistoricoVeiculoPage_div_10_div_2_Template, 4, 0, "div", 18)(3, VistoriaHistoricoVeiculoPage_div_10_ion_card_3_Template, 3, 1, "ion-card", 19)(4, VistoriaHistoricoVeiculoPage_div_10_ion_card_4_Template, 9, 2, "ion-card", 17);
    \u0275\u0275elementStart(5, "ion-item")(6, "ion-label");
    \u0275\u0275text(7, "\xC1rea");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "ion-select", 20);
    ...
    \u0275\u0275elementStart(9, "ion-select-option", 21);
    \u0275\u0275text(10, "Todas");
    \u0275\u0275elementEnd();
    \u0275\u0275template(11, VistoriaHistoricoVeiculoPage_div_10_ion_select_option_11_Template, 2, 2, "ion-select-option", 22);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "ion-item")(13, "ion-label");
    \u0275\u0275text(14, "Componente");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "ion-select", 23);
    ...
    \u0275\u0275elementStart(16, "ion-select-option", 21);
    \u0275\u0275text(17, "Todos");
    \u0275\u0275elementEnd();
    \u0275\u0275template(18, VistoriaHistoricoVeiculoPage_div_10_ion_select_option_18_Template, 2, 2, "ion-select-option", 22);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(19, VistoriaHistoricoVeiculoPage_div_10_div_19_Template, 2, 1, "div", 24)(20, VistoriaHistoricoVeiculoPage_div_10_ng_template_20_Template, 3, 2, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function VistoriaHistoricoVeiculoPage_div_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "ion-button", 59);
...
var VistoriaHistoricoVeiculoPage = class _VistoriaHistoricoVeiculoPage {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VistoriaHistoricoVeiculoPage, selectors: [["app-vistoria-historico-veiculo"]], decls: 12, vars: 7, consts: [["emptyState", ""], ["semImagensTpl", ""], ["semAudiosTpl", ""], ["selectVehicleHint", ""], [3, "translucent"], ["slot", "start"], ["menu", "main-menu"], ["slot", "end", 4, "ngIf"], [3, "fullscreen"], ["class", "content", 4, "ngIf"], ["class", "image-overlay", 3, "click", 4, "ngIf"], ["slot", "end"], ["fill", "solid", 3, "click"], [1, "content"], ["name", "crescent"], ["color", "danger"], [1, "error-message"], [4, "ngIf"], ["class", "search-loading", 4, "ngIf"], ["class", "search-results", 4, "ngIf"], ["interface", "popover", "placeholder", "Todas", 3, "ngModelChange", "ionChange", "ngModel"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], ["interface", "popover", "placeholder", "Todos", 3, "ngModelChange", "ngModel"], ["class", "cards-container", 4, "ngIf", "ngIfElse"], ["position", "stacked"], ["placeholder", "Digite placa ou descri\xE7\xE3o", 3, "ionInput", "ionClear", "value"], [1, "search-loading"], [1, "search-results"], ["lines", "none", "button", "", 3, "click", 4, "ngFor", "ngForOf"], ["lines", "none", "button", "", 3, "click"], [1, "veiculo-destaque"], [3, "value"], [1, "cards-container"], ["class", "level-card", 4, "ngFor", "ngForOf"], [1, "level-card"], [1, "midias-section"], [1, "midias-header"], [1, "midias-resumo"], ["size", "small", "fill", "outline", 3, "click", "disabled"], ["name", "crescent", 4, "ngIf"], ["class", "midias-loading", 4, "ngIf"], [1, "midias-loading"], ["class", "imagem-grid", 4, "ngIf", "ngIfElse"], ["class", "audio-list", 4, "ngIf", "ngIfElse"], [1, "imagem-grid"], [3, "src", "alt", "pointerup", "click", 4, "ngFor", "ngForOf"], [3, "pointerup", "click", "src", "alt"], [1, "sem-midia"], [1, "audio-list"], ["class", "audio-item", 4, "ngFor", "ngForOf"], [1, "audio-item"], [1, "audio-name"], ["controls", "", "preload", "none", 3, "src"], ["class", "empty-text", 4, "ngIf", "ngIfElse"], [1, "empty-text"], [1, "image-overlay", 3, "click"], [1, "image-overlay-header", 3, "click"], [1, "image-overlay-title"], ["fill", "solid", "size", "small", 3, "click"], [1, "image-overlay-body", 3, "click"], [1, "image-modal-preview", 3, "touchstart", "touchmove", "touchend", "touchcancel", "src", "alt"]], template: function VistoriaHistoricoVeiculoPage_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(6, VistoriaHistoricoVeiculoPage_ion_buttons_6_Template, 3, 0, "ion-buttons", 7);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(7, "ion-content", 8);
      \u0275\u0275template(8, VistoriaHistoricoVeiculoPage_div_8_Template, 4, 0, "div", 9)(9, VistoriaHistoricoVeiculoPage_div_9_Template, 4, 1, "div", 9)(10, VistoriaHistoricoVeiculoPage_div_10_Template, 22, 10, "div", 9);
      \u0275\u0275elementEnd();
      \u0275\u0275template(11, VistoriaHistoricoVeiculoPage_div_11_Template, 8, 5, "div", 10);
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VistoriaHistoricoVeiculoPage, { className: "VistoriaHistoricoVeiculoPage", filePath: "app/pages/vistoria/vistoria-historico-veiculo.page.ts", lineNumber: 70 });
})();
export {
  VistoriaHistoricoVeiculoPage
};
//# sourceMappingURL=chunk-NPL4Q24S.js.map
