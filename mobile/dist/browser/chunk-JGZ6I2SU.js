...
function VistoriaIrregularidadePage_ion_button_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "rect", 20)(3, "path", 21)(4, "path", 22)(5, "path", 23);
    \u0275\u0275elementEnd()();
  }
}
function VistoriaIrregularidadePage_div_18_ng_container_14_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", ctx_r1.selectedMatriz == null ? null : ctx_r1.selectedMatriz.sintoma == null ? null : ctx_r1.selectedMatriz.sintoma.descricao, " ");
  }
}
function VistoriaIrregularidadePage_div_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24)(1, "p", 25)(2, "strong");
    \u0275\u0275text(3, "Vistoria:");
    \u0275\u0275elementEnd();
    \u0275\u0275text(4);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(13);
    \u0275\u0275template(14, VistoriaIrregularidadePage_div_18_ng_container_14_Template, 5, 1, "ng-container", 18);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r1.areaNome, " \xB7 ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r1.componenteNome, " ");
    \u0275\u0275advance();
...
function VistoriaIrregularidadePage_ion_text_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-text", 28)(1, "p", 29);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function VistoriaIrregularidadePage_div_21_ion_card_2_ion_card_content_4_p_1_Template(rf, ctx) {
  if (rf & 1) {
...
function VistoriaIrregularidadePage_div_21_ion_card_2_ion_card_content_4_p_2_Template(rf, ctx) {
  if (rf & 1) {
...
function VistoriaIrregularidadePage_div_21_ion_card_2_ion_card_content_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-card-content");
    \u0275\u0275template(1, VistoriaIrregularidadePage_div_21_ion_card_2_ion_card_content_4_p_1_Template, 3, 0, "p", 18)(2, VistoriaIrregularidadePage_div_21_ion_card_2_ion_card_content_4_p_2_Template, 3, 0, "p", 18);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function VistoriaIrregularidadePage_div_21_ion_card_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "ion-card", 33);
    \u0275\u0275listener("click", function VistoriaIrregularidadePage_div_21_ion_card_2_Template_ion_card_click_0_listener() {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(4, VistoriaIrregularidadePage_div_21_ion_card_2_ion_card_content_4_Template, 3, 2, "ion-card-content", 18);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function VistoriaIrregularidadePage_div_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(2, VistoriaIrregularidadePage_div_21_ion_card_2_Template, 5, 7, "ion-card", 32);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function VistoriaIrregularidadePage_div_22_Template(rf, ctx) {
  if (rf & 1) {
...
function VistoriaIrregularidadePage_div_23_ion_text_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-text", 34)(1, "p", 29);
...
function VistoriaIrregularidadePage_div_23_ion_list_13_ion_item_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "ion-button", 45);
    \u0275\u0275listener("click", function VistoriaIrregularidadePage_div_23_ion_list_13_ion_item_1_Template_ion_button_click_5_listener() {
      const i_r7 = \u0275\u0275restoreView(_r6).index;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.removerFoto(i_r7));
    });
    \u0275\u0275element(6, "ion-icon", 46);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const foto_r8 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("src", foto_r8.preview, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(foto_r8.nomeArquivo);
  }
}
function VistoriaIrregularidadePage_div_23_ion_list_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-list");
    \u0275\u0275template(1, VistoriaIrregularidadePage_div_23_ion_list_13_ion_item_1_Template, 7, 2, "ion-item", 43);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function VistoriaIrregularidadePage_div_23_ion_item_14_p_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function VistoriaIrregularidadePage_div_23_ion_item_14_p_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("Gravando: ", ctx_r1.tempoGravacaoSegundos, "s");
  }
}
function VistoriaIrregularidadePage_div_23_ion_item_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "ion-item", 39)(1, "ion-label");
    \u0275\u0275text(2);
    \u0275\u0275template(3, VistoriaIrregularidadePage_div_23_ion_item_14_p_3_Template, 2, 1, "p", 18)(4, VistoriaIrregularidadePage_div_23_ion_item_14_p_4_Template, 2, 1, "p", 18);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 47)(6, "ion-button", 48);
    \u0275\u0275listener("click", function VistoriaIrregularidadePage_div_23_ion_item_14_Template_ion_button_click_6_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.iniciarAudio());
    });
    \u0275\u0275text(7, " Gravar ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "ion-button", 49);
    \u0275\u0275listener("click", function VistoriaIrregularidadePage_div_23_ion_item_14_Template_ion_button_click_8_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.pararAudio());
    });
    \u0275\u0275text(9, " Parar ");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.gravandoAudio);
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", ctx_r1.gravandoAudio || !ctx_r1.podeGravarAudio);
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", !ctx_r1.gravandoAudio);
  }
}
function VistoriaIrregularidadePage_div_23_ion_list_15_ion_item_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "ion-item")(1, "ion-label")(2, "p");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "audio", 50);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "ion-button", 45);
    \u0275\u0275listener("click", function VistoriaIrregularidadePage_div_23_ion_list_15_ion_item_1_Template_ion_button_click_5_listener() {
      const i_r11 = \u0275\u0275restoreView(_r10).index;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.removerAudio(i_r11));
    });
    \u0275\u0275element(6, "ion-icon", 46);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(a_r12.nomeArquivo);
    \u0275\u0275advance();
    \u0275\u0275property("src", a_r12.previewUrl, \u0275\u0275sanitizeUrl);
  }
}
function VistoriaIrregularidadePage_div_23_ion_list_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-list");
    \u0275\u0275template(1, VistoriaIrregularidadePage_div_23_ion_list_15_ion_item_1_Template, 7, 2, "ion-item", 43);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function VistoriaIrregularidadePage_div_23_ion_text_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-text", 28)(1, "p", 29);
...
function VistoriaIrregularidadePage_div_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 26);
    \u0275\u0275template(1, VistoriaIrregularidadePage_div_23_ion_text_1_Template, 3, 0, "ion-text", 36);
    \u0275\u0275elementStart(2, "ion-item")(3, "ion-label", 37);
    \u0275\u0275text(4, "Descreva o Problema");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "ion-textarea", 38, 0);
    \u0275\u0275listener("ionInput", function VistoriaIrregularidadePage_div_23_Template_ion_textarea_ionInput_5_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.observacao = $event.detail.value ?? "");
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "ion-item", 39)(8, "ion-label");
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "ion-button", 40);
    \u0275\u0275listener("click", function VistoriaIrregularidadePage_div_23_Template_ion_button_click_10_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.adicionarFoto());
    });
    \u0275\u0275element(11, "ion-icon", 41);
    \u0275\u0275text(12, " Adicionar ");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(13, VistoriaIrregularidadePage_div_23_ion_list_13_Template, 2, 1, "ion-list", 18)(14, VistoriaIrregularidadePage_div_23_ion_item_14_Template, 10, 5, "ion-item", 42)(15, VistoriaIrregularidadePage_div_23_ion_list_15_Template, 2, 1, "ion-list", 18)(16, VistoriaIrregularidadePage_div_23_ion_text_16_Template, 3, 0, "ion-text", 16);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function VistoriaIrregularidadePage_ion_footer_24_ion_spinner_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "ion-spinner", 27);
  }
}
function VistoriaIrregularidadePage_ion_footer_24_span_4_Template(rf, ctx) {
  if (rf & 1) {
...
function VistoriaIrregularidadePage_ion_footer_24_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "ion-footer")(1, "ion-toolbar")(2, "ion-button", 51);
    \u0275\u0275listener("click", function VistoriaIrregularidadePage_ion_footer_24_Template_ion_button_click_2_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.salvarIrregularidade());
    });
    \u0275\u0275template(3, VistoriaIrregularidadePage_ion_footer_24_ion_spinner_3_Template, 1, 0, "ion-spinner", 52)(4, VistoriaIrregularidadePage_ion_footer_24_span_4_Template, 2, 0, "span", 18);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", ctx_r1.saving || !ctx_r1.selectedMatriz);
    \u0275\u0275advance();
...
var VistoriaIrregularidadePage = class _VistoriaIrregularidadePage {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VistoriaIrregularidadePage, selectors: [["app-vistoria-irregularidade"]], viewQuery: function VistoriaIrregularidadePage_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function VistoriaIrregularidadePage_Template_ion_button_click_15_listener() {
        return ctx.voltar();
      });
      \u0275\u0275text(16, "Voltar");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(17, "ion-content", 13);
      \u0275\u0275template(18, VistoriaIrregularidadePage_div_18_Template, 15, 5, "div", 14)(19, VistoriaIrregularidadePage_div_19_Template, 4, 0, "div", 15)(20, VistoriaIrregularidadePage_ion_text_20_Template, 3, 1, "ion-text", 16)(21, VistoriaIrregularidadePage_div_21_Template, 3, 1, "div", 17)(22, VistoriaIrregularidadePage_div_22_Template, 3, 0, "div", 15)(23, VistoriaIrregularidadePage_div_23_Template, 17, 7, "div", 15);
      \u0275\u0275elementEnd();
      \u0275\u0275template(24, VistoriaIrregularidadePage_ion_footer_24_Template, 5, 3, "ion-footer", 18);
    }
    if (rf & 2) {
...
//# sourceMappingURL=chunk-JGZ6I2SU.js.map
